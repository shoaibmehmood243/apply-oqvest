                                    ...
                                    if(loanApplicationResult.length > 0 && loanApplicationResult[0].is_active === 1) {
                                        ...
                                        conn.query(query, loanApplicationId, async(err, personalInfo)=> {
                                            if(err){
                                                ...
                                                query = `SELECT * FROM properties WHERE loan_application_id = ?`;
                                                    ...
                                                    if(err) {
                                                        ...
                                                        conn.query(query, loanApplicationId, async(err, martialStatus)=> {
                                                            if(err) {
                                                                ...
                                                                query = `SELECT * FROM borrowers WHERE loan_application_id = ?`;
                                                                    ...
                                                                    if(err) {
                                                                        ...
                                                                        conn.query(query, loanApplicationId, async(err, realEstate)=> {
                                                                            if(err) {
                                                                                ...
                                                                                query = `SELECT * FROM loan_verifications WHERE loan_application_id = ?`;
                                                                                conn.query(query, loanApplicationId, async(err, loanVerifications)=> {
                                                                                    if(err) {
                                                                                        conn.rollback(() => {
                                                                                            conn.release();
                                                                                            reject(err);
