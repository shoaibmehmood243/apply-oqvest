    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-8 m-auto text-center'>
                <h1 className='text-900 text-2xl md:text-4xl mt-5'>Verify Loan Application</h1>
                <p>Please review and verify your information. We will use the information you provide to process your loan application</p>
                <h4 className='text-900 text-xl md:text-xl font-semibold mt-4 mb-6'>Your Current Expenses for 1919 Williams Mine Road</h4>
                <div className='w-11 md:w-10'>
                    <h6 className='text-md font-semibold mb-2 text-start'>First Mortgage Payment</h6>
                    <div>
                        <div className=" flex justify-content-center align-items-center m-auto slides-main">
                            <div className="slider-labels w-10rem text-sm text-gray-500">Monthly Amount</div>
                    ...
                    <div className='mt-4'>
                        <div className=" flex justify-content-center align-items-center m-auto slides-main">
                            <div className="slider-labels w-10rem text-sm text-gray-500">Total Expenses</div>
