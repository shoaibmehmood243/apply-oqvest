    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-12 m-auto text-center'>
                ...
                <div className='dropdown w-full md:w-full lg:w-10 m-auto'>
                ...
                <div className="mt-6 flex align-items-center justify-content-center gap-4">
                    ...
                    <button className='btn-dark' type='submit' onClick={()=> { formData.downPaymentSource !== '' && setStep(step+1)}}>Next</button>
                </div>
            </div>
        </div>
    )
