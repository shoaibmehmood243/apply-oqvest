    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-8 m-auto text-center'>
                ...
                <h4 className='text-900 text-xl md:text-2xl font-semibold mt-4 mb-2'>Your Social Security Number (or ITIN)</h4>
                <div className='w-11 md:w-6 my-6 m-auto'>
                    ...
                    <span className='block text-start'>Don't worry, this is private and is needed to securely complete the application process.</span>
                </div>
