    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-8 m-auto text-center'>
                ...
                <div className='w-full md:w-11 lg:w-8 m-auto text-center'>
                    <h4 className='text-900 text-xl md:text-2xl font-semibold mt-6 mb-2'>Real Estate Agent Information (optional)</h4>
                    <div className='dropdown'>
                        ...
                        <span className='block text-start mt-2 text-gray-700'>If you are not currently working with a real estate agent. click here.</span>
                    </div>
