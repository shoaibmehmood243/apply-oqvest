    ...
    return (
        <div>
            <div className='w-full md:w-11 lg:w-12 m-auto text-center'>
                ...
                <h4 className='text-900 text-xl md:text-2xl font-semibold mt-6 mb-2'>Your Current Loan Balance</h4>
                <div className='w-11 md:w-8 m-auto'>
                    ...
                    <span className='block mt-2 text-start'>Get this from your most recet statement. Otherwise, provide your best estimate</span>
                </div>
